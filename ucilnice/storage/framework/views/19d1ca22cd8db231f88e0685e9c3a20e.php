            ...
            <div class="col-lg-8 text-center">
                ...
                <?php if(auth()->guard()->guest()): ?>
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg px-5">
                            <i class="fas fa-sign-in-alt me-2"></i>Prijava
                        </a>
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg px-5">
                            <i class="fas fa-user-plus me-2"></i>Registracija
                        </a>
                    </div>
                <?php else: ?>
                    <div class="d-flex gap-3 justify-content-center">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-primary btn-lg px-5">
                            <i class="fas fa-home me-2"></i>Nadzorna plošča
                        </a>
                        <a href="<?php echo e(route('ucilnice.index')); ?>" class="btn btn-outline-primary btn-lg px-5">
